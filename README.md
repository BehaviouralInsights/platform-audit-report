...
[this URL](https://behaviouralinsights.github.io/platform-audit-report/)
...
# Encrypt the report and change the color scheme and title of the landing page
npx staticrypt index.html \
    -p <long-password> \
    --template-color-primary "#E5E7EB" \
    --template-color-secondary "#FFFFFF" \
    --template-title "Platform audit"
